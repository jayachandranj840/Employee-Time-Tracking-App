        ...
        function fetchDataAndUpdateCharts() {
            $.ajax({
                ...
                success: function(responseData) {
                    ...
                    if (responseData.daily && responseData.daily.labels && responseData.daily.data) {
                        updateDailyChart(responseData.daily);
                    } else {
                        console.error('Daily data is empty or invalid.');
                    }
                    if (responseData.weekly && responseData.weekly.labels && responseData.weekly.data) {
                        updateWeeklyChart(responseData.weekly);
                    } else {
                        console.error('Weekly data is empty or invalid.');
                    }
                    if (responseData.monthly && responseData.monthly.labels && responseData.monthly.data) {
